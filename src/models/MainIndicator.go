...
type MainIndicatorReq struct {
	...
	ReportDateType int    `json:"reportDateType,omitempty"`
}
...
// Result 主要指标返回值
type Result struct {
	Enterprise []Enterprise `json:"ZhuYaoZhiBiaoList_QiYe,omitempty"`
	// YinHang   YinHang   `json:"ZhuYaoZhiBiaoList_YinHang,omitempty"`
	// QuanShang QuanShang `json:"ZhuYaoZhiBiaoList_QuanShang,omitempty"`
	// BaoXian   BaoXian   `json:"ZhuYaoZhiBiaoList_BaoXian,omitempty"`
}
